                  ...
                  <div class="col-md-6">
                     <select name="category_id" class="form-control" id="category">
                        @foreach ($categories as $category)
                            <option value="{{ $category->id }}" @if ($category->id == $product->category_id) selected='selected' @endif>
                  ...
                  <div class="col-md-6" id="subcategory">
                      <select name="subcategory_id" class="form-control" id="freesubcategory">
                          @foreach ($subCategories as $Subcategory)
                                    <option value="{{ $Subcategory->id }}" @if ($Subcategory->id == $product->subcategory_id) selected='selected' @endif>
                  ...
                  <div class="col-md-6" id="childcategory">
                      <select name="childcategory_id" class="form-control" id="freechildcategory">  
                                ...
                                @foreach ($childCategories as $childCategory)
                                    <option value="{{ $childCategory->id }}" @if ($childCategory->id == $product->childcategory_id) selected='selected' @endif>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                           <textarea rows="8"  class="form-control" type="text"  name="description" id="description" required>{{$product->description}}</textarea>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                           <input  class="form-control" type="text" name="in_stock"
                            value="{{$product->in_stock}}" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                           <input  class="form-control" type="text" name="available_colors" value="{{$product->available_colors}}" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                           <input  class="form-control" type="text" name="available_sizes" value="{{$product->available_sizes}}">
                        </div>
                    </div>
