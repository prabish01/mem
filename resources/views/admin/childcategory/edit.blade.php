    ...
    <div class="content-wrapper">
        <div class="box box-primary">
            ...
            <div class="box-header">
                <h3>Edit Childcategory</h3>
            </div>
            <div class="box-body">
                <form class="form-horizontal" method="post" action="{{url('childcategory/update', $childcategory->id)}}" enctype="multipart/form-data">
                    @method('PUT')
                    {{csrf_field()}}
                        ...
                        <div class="col-md-6">
                            <select name="category_id" class="form-control" id="category">
                                <option value="{{$childcategory->category_id}}">
                                    {{$childcategory->parentCategory->category_name}}
                                </option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6" id="subcategory">
                            <select name="subcategory_id" class="form-control" id="freesubcategory">
                                <option value="{{$childcategory->subcategory_id}}">
                                    <!--{{$childcategory->parentSubCategory->subcategory_name}}-->
                               @isset($childcategory->subcategory_id)
                                {{$childcategory->parentSubCategory->subcategory_name}}
                                @endisset
                                </option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input  class="form-control" type="text" name="childcategory_name" value="{{$childcategory->childcategory_name}}" required>
                        </div>
                    </div>
