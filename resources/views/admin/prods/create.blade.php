...
@section('admin-content')
    <div class="content-wrapper">
        ...
        <div class="box box-primary p-10">
            ...
            <div class="box-body">
                <form class="form-horizontal" method="post" action="{{url('prods/store')}}" enctype="multipart/form-data">
                    {{csrf_field()}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                           <textarea rows="10" class="form-control" type="text"  name="prods_description" required></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-4 control-label">Main Product Image</label>
                        <div class="col-md-6">
                            <input  class="form-control" type="file"  onchange="previewFile()" name="prods_image" required>
