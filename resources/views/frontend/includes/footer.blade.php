                ...
                <div class="col-md-3 order-3 third">
                    ...
                    <div class="footer-social">
                        <a href="https://www.facebook.com/ManokamanaEarthMoversPvtLtd" target="_blank">
                            <img src="{{asset('assets/img/facebook.png')}}" alt="Follow Manokamana Earthmovers on Facebook">
                        </a>
                        <a href="" target="_blank">
                            <img src="{{asset('assets/img/instagram.png')}}" alt="Follow Manokamana Earthmovers on Instagram">
                        </a>
                        <a href="" target="_blank">
                            <img src="{{asset('assets/img/youtube.png')}}" alt="Subscribe to Manokamana Earthmovers on YouTube">
                        </a>
                    </div>
                    <div class="mt-3">
                        <a href="">
                            <img class="app-img" src="{{asset('assets/img/playstore.png')}}" width="150px;" alt="Download Manokamana Earthmovers App from Google Play Store">
                        </a>
                    </div>
                </div>
            </div>
