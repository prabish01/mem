...
@section('title')
{{ $product->meta_title ? $product->meta_title : $product->product_name}}
@endsection

@section('meta_description')
{{$product->meta_description ? $product->meta_description : strip_tags($product->description)}}
@endsection

@section('meta_keywords')
{{$product->meta_keywords ? $product->meta_keywords : $product->product_name}}
@endsection
            ...
            <nav class="flex" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 text-sm">
                    ...
                    <li class="flex items-center">
                        ...
                        <a href="#"
                            class="text-gray-600 hover:text-gray-900">{{$product->parentCategory->category_name}}</a>
                    </li>
                    @endisset
                </ol>
            </nav>
            ...
            <div class="md:flex">
                ...
                <div class="md:w-[450px] p-6 bg-gray-50 flex items-center justify-center">
                    <div class="relative w-full h-[350px]">
                        <img src="{{ asset('uploads/product/'.$product->image) }}" alt="{{$product->product_name}}"
                            class="w-full h-full object-contain">
                        @if ($product->in_stock <= 0) <div class="absolute top-0 right-0 m-4">
                            <span
                ...
                <div class="space-y-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            <div class="flex items-baseline space-x-3">
                                ...
                                <span class="text-lg text-gray-500 line-through">NPR {{ number_format($product->mrp)
                                    }}</span>
                    ...
                    <div class="grid grid-cols-2 gap-4 py-6 text-sm">
                        ...
                        <div>
                            ...
                            <p class="mt-1 font-medium text-gray-900">{{$product->parentSubCategory->subcategory_name}}
                            </p>
                        </div>
                        @endisset
                    </div>
                    ...
                    <div class="py-6 border-t">
                        <h3 class="text-sm font-medium text-gray-900 uppercase tracking-wide mb-4">Product Description
                        </h3>
                        ...
                        <div class="flex items-end space-x-4 mb-6">
                            <div>
                                ...
                                <input type="number" name="qty"
                                    ...
                                    value="1" min="1" max="{{$product->in_stock}}" required>
                            </div>
